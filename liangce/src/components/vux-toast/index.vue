...
<style lang="less">
@import '~cssPath/transition.less';
@import '~cssPath/weui/widget/weui_tips/weui_mask';
@import '~cssPath/weui/icon/weui_icon_font';
@import '~cssPath/weui/widget/weui_tips/weui_toast';
